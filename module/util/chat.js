...
const twduChat ={
  ...
  template: {
    weapon: "systems/twdu/templates/ui/chatWeapon.hbs"
  }
...
export const buildChatCard = function (type, data, chatOptions={}) {
  ...
  console.log("TWDU | token: ", token);

  switch (type) {
    case "weapon":
      console.log("TWDU | weapon data: ", data);
      console.log("TWDU | weapon chat card", twduChat.template.weapon);
      let skill = "";
